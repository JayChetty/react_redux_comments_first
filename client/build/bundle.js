...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentRestAdapter = __webpack_require__(163);
	
	var accountsStore = __webpack_require__(164);
	...
	var CommentBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(CommentForm, { onCommentSubmit: this.props.onCommentSubmit })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    this.props.onCommentSubmit({ author: author, text: text, id: Date.now() });
	  },
	  render: function render() {
	    return React.createElement(
	      'form',
...
/***/ function(module, exports) {
	...
	var CommentRestAdapter = function CommentRestAdapter(url, store) {
	  this.url = url;
	  this.store = store;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(accounts);
